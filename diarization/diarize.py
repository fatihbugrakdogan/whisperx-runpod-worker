...
# `condition_on_previous_text=False` — Whisper'ın #1 halüsinasyon kaynağı önceki
# segmentin bağlamını zorla taşımasıdır. Uzun sessizliklerde "Altyazı: M.K." veya
# aynı cümlenin tekrarları bu yüzden oluşur. Psikoterapi seanslarında sessizlikler
# uzun olduğu için bu davranış özellikle yıkıcı; conditioning'i kapatmak hata
# birikmesini engeller. Tek konuşmacının uzun bir replikası bağlam kaybedebilir,
# ama bu trade-off halüsinasyondan iyi.
